...
{
	return("<div class=gensideblock><div class=gensideblock style='width:"+labW+";border-bottom: #ccc 1px solid;background-color: #ccc;'>" + CUi.getPushUpTextNode(label) + ":</div><div id='" + datID + "' class=gensideblock style='width:"+datW+";padding-left:2px;padding-right:2px;border-bottom: #ccc 1px solid;'>" + ((CUtil.varok(datTxt)) ? (CUi.getPushUpTextNode(datTxt)) : ('')) + "</div></div>");
}
...
CUi.regWinResize = function(enlargeProir,shrinkPrior,info)
{
	var def = {
...
CUi.setSoleModalBodyHTML = function(zi,inHtml,cid,w,h,caption)
{
	...
	html += "<div name=blockerFullCon style=\"border: #ccc 2px ridge;padding: 5px;background-color:#FFF;color:#000;text-align:left;position:relative;width:"+w+";height:"+h+"\">";
